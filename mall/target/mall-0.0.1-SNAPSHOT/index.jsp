...
<nav class="navbar navbar-secondary bg-secondary">
  <div class="container-fluid">
    ...
    <!--  <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">-->
      <button class="btn btn-outline-black" type="submit">About Us</button>
     &nbsp;&nbsp; <button class="btn btn-outline-black" style="text-align: left; type="submit">Contact</button>
    </form>
  </div>
...
<div align="center">
<a href="admin.jsp" class="btn btn-outline-black" type="submit">Admin Login</a>
