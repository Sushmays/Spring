...
<div class="form-group">
  ...
  <input name="age" placeholder="Enter your age" class="form-control" type="number">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button type="submit" class="btn btn-Secondary" >Send <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
