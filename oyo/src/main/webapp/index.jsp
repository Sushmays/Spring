...
<body>
	...
	<form action="oyo" method="post">
		OwnerName <input type="text" name="ownerName" ${dto.ownerName }/> <br>
		<br> Place <select name="place"  ${dto.name }>
		...
		<br> Name <select name="name"  ${dto.name }>
			<option>--Select--</option>
			<option>Oberoi</option>
			<option>Holiday</option>
			<option>Hyatt Centric</option>
			<option>WelcomeHotel</option>
			<option>Park</option>
		</select> <br>
		<br> Type <input type="text" name="type"   ${dto.type } /> <br>
		<br> Price <input type="number" name="price" ${dto.price } /> <br>
		<br> Company <input type="text" name="company"  ${dto.company } /> <br>
		<br> Website <input type="text" name="webSite" ${dto.webSite } /> <br>
		<br> Since <input type="number"  name="since"  ${dto.since }/> <br>
		<br>
